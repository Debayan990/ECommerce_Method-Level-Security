...
public class CartPullService {
    ...
    public CartDto getCart(String username) {
        ...
        return cartServiceClient.getCart(username);
    }
    ...
    public void clearCartFallback(String username, Throwable th) {
        ...
        // We might not want to fail the whole order if clearing fails,
        // but for safety, we alert the user or log it as a critical warning.
        // Ideally, this would publish an event to a retry queue.
